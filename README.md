...
OR The user can add the folder in which they store their .mp3 files in the Scan folders section
-Stored songs must follow the specified naming scheme for .mp3 files -> "Artist - Song name" the "-" separates artist name from song name
