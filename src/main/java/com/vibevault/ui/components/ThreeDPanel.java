...
public class ThreeDPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 1; i <= glowSteps; i++) {
            ...
            float alpha_f = (float) Math.exp(-t * t * 6.5f);
            int   alpha   = (int) (alpha_f * 55);
            int   expand  = (int) (t * glowRadius);

            // Dark-navy glow colour matching the reference panel hue
            g2.setColor(new Color(5, 12, 28, Math.max(1, alpha)));
            g2.fillRoundRect(
                    fx - expand,      fy - expand,
        ...
        Color faceLight = new Color(75, 145, 210, 210);
        Color faceDark  = new Color(45, 100, 175, 230);
        ...
        java.awt.RadialGradientPaint spotPaint = new java.awt.RadialGradientPaint(
                ...
                fw * 0.45f,
                new float[]{ 0f, 1f },
                new Color[]{ new Color(120, 200, 255, 55),
                        new Color(120, 200, 255, 0) });
        ...
        g2.setColor(new Color(180, 220, 255, 60));
